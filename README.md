...
### Output
The result of this is a graph of possible maneuver options with the lowest delta-V solution (the graph as generated by NetworkX and the satellite states at each node). An image of the graph can be generated as well with the lowest delta-V solution highlighted. 
